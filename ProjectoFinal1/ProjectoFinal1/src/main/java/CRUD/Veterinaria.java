...
public class Veterinaria extends javax.swing.JFrame {
   ...
   conexion con = new conexion(); 
    ...
    public static void generateExcel(Connection connection) {
        ...
        String[] headers = {"ID", "Fecha", "Sitio", "Artículo", "Tipo", "Precio", "Cantidad"};
        ...
        try {
            ...
            resultSet = statement.executeQuery("SELECT id, fecha, sitio, articulo, tipo, precio, cantidad FROM veterinaria");
...
void Agregar() {
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null, "Los campos precio y cantidad deben ser números válidos.");
        return;
    }
    ...
    try {
        if (sitio.equals("") || articulo.equals("") || tipo.equals("Seleccione:") || fecha.equals("") || precio == null || cantidad == null) {
            JOptionPane.showMessageDialog(null, "Ingrese todos los datos");
        } else {
            String sql = "INSERT INTO veterinaria(articulo, fecha, precio, cantidad, sitio, tipo) VALUES('" + articulo + "','" + fecha + "','" + precio + "','" + cantidad + "','" + sitio + "','" + tipo + "')";
             conect=con.getConnection();
                st=conect.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Datos ingresados");
                LimpiarTabla(); // Método que deberías implementar para limpiar la tabla si es necesario
        }
    } catch (Exception e) {
